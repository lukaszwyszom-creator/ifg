...
from guardian_platform.profiles.ifg.config.defaults import FRONTEND_SRC_PREFIX, IGNORE_PATTERNS
from guardian_platform.profiles.ifg.lib.line_endings import (
    Confidence,
    LineEndingCategory,
...
from guardian_platform.core.workflow.stage import BuildReason
