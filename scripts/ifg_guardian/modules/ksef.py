...
from ifg_guardian.config import COMPOSE_FILE, ROOT
...
def run_ksef_sync(*, dry_run: bool = True) -> int:
    """Placeholder — mutating sync requires explicit future implementation."""
    print("IFG Guardian — ksef sync")
    print("=" * 40)
    if dry_run:
        print("Tryb read-only: użyj `guardian deploy run` lub API sync-purchase.")
        print("Brak automatycznej synchronizacji KSeF w Guardian v3 etap 1.")
    print("\nStatus: NOT IMPLEMENTED (etap 2)")
    return 1
