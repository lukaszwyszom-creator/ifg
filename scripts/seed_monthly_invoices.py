...
SALE_MARCH = [
    {"buyer_id": BUYER_PL, "issue_date": "2026-03-03", "sale_date": "2026-03-03", "due_date": "2026-03-17",
     "currency": "PLN", "direction": "sale",
     "items": [{"name": "Usługa wdrożeniowa", "quantity": "8", "unit": "godz",
                "unit_price_net": "180.00", "vat_rate": "0.23"}]},
    {"buyer_id": BUYER_PL, "issue_date": "2026-03-10", "sale_date": "2026-03-10", "due_date": "2026-03-24",
     "currency": "PLN", "direction": "sale",
    ...
    {"buyer_id": BUYER_DE, "issue_date": "2026-03-17", "sale_date": "2026-03-17", "due_date": "2026-03-31",
     "currency": "EUR", "direction": "sale",
     "items": [{"name": "Consulting services", "quantity": "12", "unit": "h",
                "unit_price_net": "90.00", "vat_rate": "0.00"}]},
    {"buyer_id": BUYER_PL, "issue_date": "2026-03-25", "sale_date": "2026-03-25", "due_date": "2026-04-08",
     "currency": "PLN", "direction": "sale",
...
SALE_APRIL = [
    {"buyer_id": BUYER_PL, "issue_date": "2026-04-01", "sale_date": "2026-04-01", "due_date": "2026-04-15",
     "currency": "PLN", "direction": "sale",
     "items": [{"name": "Usługa programistyczna", "quantity": "10", "unit": "godz",
                "unit_price_net": "160.00", "vat_rate": "0.23"}]},
    {"buyer_id": BUYER_PL, "issue_date": "2026-04-03", "sale_date": "2026-04-03", "due_date": "2026-04-17",
     "currency": "PLN", "direction": "sale",
     "items": [{"name": "Szkolenie online", "quantity": "2", "unit": "dzień",
                "unit_price_net": "800.00", "vat_rate": "0.23"}]},
    {"buyer_id": BUYER_DE, "issue_date": "2026-04-05", "sale_date": "2026-04-05", "due_date": "2026-04-19",
     "currency": "EUR", "direction": "sale",
     "items": [{"name": "API integration", "quantity": "15", "unit": "h",
                "unit_price_net": "95.00", "vat_rate": "0.00"}]},
    {"buyer_id": BUYER_PL, "issue_date": "2026-04-07", "sale_date": "2026-04-07", "due_date": "2026-04-21",
     "currency": "PLN", "direction": "sale",
     "items": [{"name": "Licencja roczna", "quantity": "3", "unit": "szt",
                "unit_price_net": "399.00", "vat_rate": "0.23"}]},
    {"buyer_id": BUYER_PL, "issue_date": "2026-04-09", "sale_date": "2026-04-09", "due_date": "2026-04-23",
     "currency": "PLN", "direction": "sale",
     "items": [{"name": "Hosting premium", "quantity": "1", "unit": "mies",
                "unit_price_net": "900.00", "vat_rate": "0.23"}]},
    {"buyer_id": BUYER_PL, "issue_date": "2026-04-11", "sale_date": "2026-04-11", "due_date": "2026-04-25",
     "currency": "PLN", "direction": "sale",
     "items": [{"name": "Analiza bezpieczeństwa", "quantity": "5", "unit": "godz",
                "unit_price_net": "220.00", "vat_rate": "0.23"}]},
    {"buyer_id": BUYER_PL, "issue_date": "2026-04-14", "sale_date": "2026-04-14", "due_date": "2026-04-28",
     "currency": "PLN", "direction": "sale",
...
PURCHASE_MARCH = [
    {"buyer_id": BUYER_PL, "issue_date": "2026-03-02", "sale_date": "2026-03-02", "due_date": "2026-04-01",
     "currency": "PLN", "direction": "purchase",
     "items": [{"name": "Laptop Dell XPS", "quantity": "1", "unit": "szt",
                "unit_price_net": "4500.00", "vat_rate": "0.23"}]},
    {"buyer_id": BUYER_PL, "issue_date": "2026-03-04", "sale_date": "2026-03-04", "due_date": "2026-04-03",
     "currency": "PLN", "direction": "purchase",
     "items": [{"name": "Licencja Adobe CC", "quantity": "1", "unit": "rok",
                "unit_price_net": "2700.00", "vat_rate": "0.23"}]},
    {"buyer_id": BUYER_PL, "issue_date": "2026-03-06", "sale_date": "2026-03-06", "due_date": "2026-04-05",
     "currency": "PLN", "direction": "purchase",
     "items": [{"name": "Najem biura", "quantity": "1", "unit": "mies",
                "unit_price_net": "1200.00", "vat_rate": "0.23"}]},
    {"buyer_id": BUYER_PL, "issue_date": "2026-03-09", "sale_date": "2026-03-09", "due_date": "2026-04-08",
     "currency": "PLN", "direction": "purchase",
     "items": [{"name": "Usługi księgowe", "quantity": "1", "unit": "mies",
                "unit_price_net": "600.00", "vat_rate": "0.23"}]},
    {"buyer_id": BUYER_PL, "issue_date": "2026-03-12", "sale_date": "2026-03-12", "due_date": "2026-04-11",
     "currency": "PLN", "direction": "purchase",
     "items": [{"name": "Internet światłowodowy", "quantity": "1", "unit": "mies",
                "unit_price_net": "180.00", "vat_rate": "0.23"}]},
    {"buyer_id": BUYER_PL, "issue_date": "2026-03-15", "sale_date": "2026-03-15", "due_date": "2026-04-14",
     "currency": "PLN", "direction": "purchase",
     "items": [{"name": "Oprogramowanie antywirusowe", "quantity": "5", "unit": "szt",
                "unit_price_net": "89.00", "vat_rate": "0.23"}]},
    {"buyer_id": BUYER_PL, "issue_date": "2026-03-18", "sale_date": "2026-03-18", "due_date": "2026-04-17",
     "currency": "PLN", "direction": "purchase",
     "items": [{"name": "Drukarka laserowa", "quantity": "1", "unit": "szt",
                "unit_price_net": "1100.00", "vat_rate": "0.23"}]},
    {"buyer_id": BUYER_PL, "issue_date": "2026-03-21", "sale_date": "2026-03-21", "due_date": "2026-04-20",
     "currency": "PLN", "direction": "purchase",
     "items": [{"name": "Paliwo – delegacja", "quantity": "1", "unit": "szt",
                "unit_price_net": "340.00", "vat_rate": "0.23"}]},
    {"buyer_id": BUYER_PL, "issue_date": "2026-03-28", "sale_date": "2026-03-28", "due_date": "2026-04-27",
     "currency": "PLN", "direction": "purchase",
...
PURCHASE_APRIL = [
    {"buyer_id": BUYER_PL, "issue_date": "2026-04-02", "sale_date": "2026-04-02", "due_date": "2026-05-02",
     "currency": "PLN", "direction": "purchase",
     "items": [{"name": "Najem biura", "quantity": "1", "unit": "mies",
                "unit_price_net": "1200.00", "vat_rate": "0.23"}]},
    {"buyer_id": BUYER_PL, "issue_date": "2026-04-03", "sale_date": "2026-04-03", "due_date": "2026-05-03",
     "currency": "PLN", "direction": "purchase",
     "items": [{"name": "Usługi księgowe", "quantity": "1", "unit": "mies",
                "unit_price_net": "600.00", "vat_rate": "0.23"}]},
    {"buyer_id": BUYER_PL, "issue_date": "2026-04-04", "sale_date": "2026-04-04", "due_date": "2026-05-04",
     "currency": "PLN", "direction": "purchase",
     "items": [{"name": "Internet światłowodowy", "quantity": "1", "unit": "mies",
                "unit_price_net": "180.00", "vat_rate": "0.23"}]},
    {"buyer_id": BUYER_PL, "issue_date": "2026-04-06", "sale_date": "2026-04-06", "due_date": "2026-05-06",
     "currency": "PLN", "direction": "purchase",
     "items": [{"name": "Subskrypcja GitHub Teams", "quantity": "3", "unit": "szt",
                "unit_price_net": "44.00", "vat_rate": "0.23"}]},
    {"buyer_id": BUYER_PL, "issue_date": "2026-04-08", "sale_date": "2026-04-08", "due_date": "2026-05-08",
     "currency": "PLN", "direction": "purchase",
     "items": [{"name": "AWS – chmura obliczeniowa", "quantity": "1", "unit": "mies",
                "unit_price_net": "750.00", "vat_rate": "0.23"}]},
    {"buyer_id": BUYER_PL, "issue_date": "2026-04-10", "sale_date": "2026-04-10", "due_date": "2026-05-10",
     "currency": "PLN", "direction": "purchase",
     "items": [{"name": "Szkolenie BHP", "quantity": "4", "unit": "os",
                "unit_price_net": "85.00", "vat_rate": "0.23"}]},
    {"buyer_id": BUYER_PL, "issue_date": "2026-04-13", "sale_date": "2026-04-13", "due_date": "2026-05-13",
     "currency": "PLN", "direction": "purchase",
     "items": [{"name": "Paliwo – delegacja", "quantity": "1", "unit": "szt",
