...
**Generated:** 2026-07-08 22:34:44 UTC  
**Mode:** LIVE  
**Deployment risk:** `MEDIUM`  
**Doctor status:** `READY_WITH_WARNINGS`  
**Release plan:** `2026-07-08T223207Z_ifg_release_plan`  
**Release evaluate:** `2026-07-08T223218Z_ifg_release_evaluate`  
...
ifg-api-1           ifg-api:latest      "uvicorn app.main:ap…"   api                 42 seconds ago      Up 1 second (health: starting)   127.0.0.1:8000->8000/tcp
ifg-db-1            postgres:17         "docker-entrypoint.s…"   db                  36 hours ago        Up 36 hours (healthy)            5432/tcp
ifg-worker-1        ifg-api:latest      "sh -c 'python -m ap…"   worker              42 seconds ago      Up 2 seconds
```
