...
**Generated:** 2026-07-10 21:48:44 UTC  
**Mode:** DRY-RUN  
**Deployment risk:** `CRITICAL`  
**Doctor status:** `BLOCKED`  
**Release plan:** `2026-07-10T214835Z_ifg_release_plan`  
**Release evaluate:** `2026-07-10T214838Z_ifg_release_evaluate`  
**Release decision:** `PRODUCTION_BLOCKED`  
**Workflow ID:** `2026-07-10T214835Z_ifg_deploy_run`  
**Duration:** 0 ms  
...
- 🛑 Policy blocker: [frontend] npm run build: ❌ [lokalnie] niezcommitowane zmiany frontend-react/src — dist nieaktualny (cd frontend-react && npm run build)
...
- ⚠ ACTION_REQUIRED: Zbuduj frontend (`npm run build`) i odśwież artefakty dist.
- ⚠ ACTION_REQUIRED: Wymagany rebuild obrazów api/worker przed produkcją.
- ⚠ ACTION_REQUIRED: Zweryfikuj untracked pliki przed produkcją: .state/, Architecture/, docs/FV_AUTO_WZ_IMPLEMENTATION_PLAN.md, docs/FV_DRAFT_LOCKED_NUMBERING_MODEL.md, docs/FV_NUMBERING_RENUMBERING_BUG.md, docs/FV_STATUS_NUMBERING_POLICY_REVIEW.md, docs/FV_WZ_AUTO_SYNC_ANALYSIS.md, docs/IFG_LONG_RUNNING_OPERATIONS_STANDARD.md
