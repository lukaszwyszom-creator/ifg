...
- Policy rule triggered: tests_must_pass
- Production deployment blocked. Working tree contains uncommitted changes.
- Test discovery failed.
- Test discovery: /opt/homebrew/opt/python@3.14/bin/python3.14: No module named pytest
...
- [repository] repo audit: overall risk HIGH, 210 classified file(s)
...
- Zweryfikuj untracked pliki przed produkcją: .state/, docs/FV_AUTO_WZ_IMPLEMENTATION_PLAN.md, docs/FV_DRAFT_LOCKED_NUMBERING_MODEL.md, docs/FV_NUMBERING_RENUMBERING_BUG.md, docs/FV_STATUS_NUMBERING_POLICY_REVIEW.md, docs/FV_WZ_AUTO_SYNC_ANALYSIS.md, docs/IFG_LONG_RUNNING_OPERATIONS_STANDARD.md, docs/IFG_PENDING_CHANGES_AUDIT.md
