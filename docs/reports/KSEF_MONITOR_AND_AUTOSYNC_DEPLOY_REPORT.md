...
**Generated:** 2026-07-07 08:50:06 UTC  
**Question:** Co dokładnie zostanie wykonane, jeżeli uruchomię deploy?  
**Deployment risk:** `CRITICAL`  
**Doctor status:** `BLOCKED`  
**Workflow ID:** `2026-07-07T085002Z_ifg_release_plan`  
**Duration:** 0 ms  

## Dependencies

- `ifg.doctor` → SUCCESS (2026-07-07T085002Z_ifg_doctor)

## Repository

- Branch: `production`
- HEAD: `8427144` (`842714416310070b74803ddf6dfba0fb8b5fec2a`)
- Dirty: True
- Ahead/behind: 0/0
...
- **Git SHA:** `842714416310070b74803ddf6dfba0fb8b5fec2a` — target commit for deploy
- **Frontend bundle:** `25e1bf528f64` — planned dist/assets fingerprint
- **Docker image API:** `ifg-api:8427144` — planned tag — not built in plan mode
- **Docker image Worker:** `ifg-worker:8427144` — planned tag — not built in plan mode
